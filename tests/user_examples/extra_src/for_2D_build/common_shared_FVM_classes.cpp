								...
								if (mesh_type == 3)
								{
									if (cells[check_neighbor_cell2] != 0)
									{
											...
											&& cell_lists_[cells[check_neighbor_cell2]][2][0] != cells[check_neighbor_cell1])
										{
											...
											if (cell_lists_[cells[check_neighbor_cell2]][0][0] != static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1) 
												&& cell_lists_[cells[check_neighbor_cell2]][1][0] == static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1))
											{
												cell_lists_[cells[check_neighbor_cell2]][1][0] = cells[check_neighbor_cell1];
											...
											if (cell_lists_[cells[check_neighbor_cell2]][0][0] != static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1)
												&& cell_lists_[cells[check_neighbor_cell2]][1][0] != static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1)
												&& cell_lists_[cells[check_neighbor_cell2]][2][0] == static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1))
											{
												cell_lists_[cells[check_neighbor_cell2]][2][0] = cells[check_neighbor_cell1];
										...
										if (cell_lists_[cells[check_neighbor_cell2]][0][0] != cells[check_neighbor_cell1]
											&& cell_lists_[cells[check_neighbor_cell2]][1][0] == static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(0)
											&& cell_lists_[cells[check_neighbor_cell2]][2][0] == static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1))
										{
											cell_lists_[cells[check_neighbor_cell2]][2][0] = cells[check_neighbor_cell1];
											cell_lists_[cells[check_neighbor_cell2]][2][1] = boundary_type;
									...
									if (cells[check_neighbor_cell2] != 0)
									{
											...
											&& cell_lists_[cells[check_neighbor_cell2]][3][0] != cells[check_neighbor_cell1])
										{
											...
											if (cell_lists_[cells[check_neighbor_cell2]][0][0] != static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1)
												&& cell_lists_[cells[check_neighbor_cell2]][1][0] != static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1)
												&& cell_lists_[cells[check_neighbor_cell2]][2][0] != static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1)
												&& cell_lists_[cells[check_neighbor_cell2]][3][0] == static_cast<std::decay_t<decltype(elements_nodes_connection_[0][0])>>(-1))
											{
												cell_lists_[cells[check_neighbor_cell2]][3][0] = cells[check_neighbor_cell1];
